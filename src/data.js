...
export const getEvents = () => {
  return [
    ...
    },
    {
      ...
      startDate: new Date(2021, 7, 1, 10),
      endDate: new Date(2021, 7, 1, 11, 30),
      registrationDeadline: new Date(2021, 6, 30),
      isFree: true,
    ...
    },
    {
      ...
      startDate: new Date(2021, 7, 8, 10),
      endDate: new Date(2021, 7, 8, 11, 30),
      registrationDeadline: new Date(2021, 7, 2),
      fee: 50,
      category: "competitive",
      mode: "online",
      eventFor: "student",
    ...
    },
    {
      ...
      startDate: new Date(2021, 7, 8, 17),
      endDate: new Date(2021, 7, 22, 17),
      registrationDeadline: new Date(2021, 7, 5),
      fee: 100,
      category: "competitive",
      mode: "online",
      eventFor: "student",
